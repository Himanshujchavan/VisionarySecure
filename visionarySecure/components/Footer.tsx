      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-4 md:mb-0">
            <h3 className="text-lg font-semibold mb-2">VisionarySecure</h3>
          ...
          <div className="w-full md:w-1/4">
            ...
            <p className="text-sm text-gray-600">architgulhane@6gmail.com</p>
            <p className="text-sm text-gray-600">+91 8830426425</p>
          </div>
        </div>
        <div className="mt-8 text-center text-sm text-gray-600">© 2025 VisionarySecure. All rights reserved.</div>
      </div>
    </footer>
  )
}
