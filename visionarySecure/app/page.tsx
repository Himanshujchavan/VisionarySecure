      ...
      <section className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-cyan-500/20 rounded-full filter blur-3xl"></div>
            <Image
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Flux_Dev_A_futuristic_illustration_of_a_secure_digital_vault_w_2-nx1ylXmLUt2kmpTHiAaY2tp6KCYTF0.jpeg"
              alt="AI-powered security vault with digital protection shield"
              width={600}
              height={400}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md relative">
            ...
            <p className="text-gray-600 mb-4 italic">
              "VisionarySecure has significantly reduced our fraud risks. Their system is intuitive and effective."
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md relative">
            ...
            <p className="text-gray-600 mb-4 italic">
              "Thanks to VisionarySecure, we've seen a 90% reduction in fraudulent activities. Highly recommended!"
            </p>
